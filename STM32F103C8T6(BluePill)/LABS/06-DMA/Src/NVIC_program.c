...
//	u8 priority = 0;
//
//	#if 	PRIORITY_GROUPING == GROUPS_16_SUBGROUPS_0
//			priority = Copy_u8Group;
//	#elif 	PRIORITY_GROUPING == GROUPS_8_SUBGROUPS_2
//			priority = (Copy_u8Group<<1) | Copy_u8Sub;
//	#elif 	PRIORITY_GROUPING == GROUPS_4_SUBGROUPS_4
//			priority = (Copy_u8Group<<2) | Copy_u8Sub;
//	#elif 	PRIORITY_GROUPING == GROUPS_2_SUBGROUPS_8
//			priority = (Copy_u8Group<<3) | Copy_u8Sub;
//	#elif	 PRIORITY_GROUPING == GROUPS_0_SUBGROUPS_16
//			priority = Copy_u8Sub;
//	#endif
//
//	if(Copy_u8InterruptNumber < 81)
